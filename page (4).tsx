    ...
    (
      ...
      >
        ...
        <div style={{ zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: "Georgia, serif", fontSize: lang === "zh" ? 78 : 92, lineHeight: 1.05, letterSpacing: lang === "zh" ? -2 : -4, margin: "30px 0 42px" }}>{textOf(item.title, lang)}</h1>
        ...
        <div style={{ zIndex: 1, borderLeft: "10px solid #CCFF00", padding: "28px 34px", background: "rgba(204,255,0,.09)", borderRadius: "0 30px 30px 0" }}>
          ...
          <p style={{ fontSize: lang === "zh" ? 38 : 42, lineHeight: 1.35, margin: "18px 0 0" }}>{textOf(item.moSight, lang)}</p>
        </div>
        <div style={{ zIndex: 1, display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ fontSize: lang === "zh" ? 34 : 38, lineHeight: 1.35 }}>{textOf(item.businessTalk, lang)}</div>
